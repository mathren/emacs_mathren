...
already. For clarity, this leaves in a separate =install_packages.el=
that I load.
...
** TODO configure langtool
  https://github.com/mhayashi1120/Emacs-langtool

** TODO Avoid creating tons of hidden files

   [[https://github.com/emacscollective/no-littering][no-littering]] to avoid creating too many hidden files.
   however, this conflicts with emacs ein, deactivated for now
#+BEGIN_SRC emacs-lisp  :tangle ~/Documents/dotfiles/emacs26.3/dot-emacs.d/init.el

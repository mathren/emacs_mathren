...
Minibuffer/search framework: =consult=. Allows for live preview.
...
** TODO minor customization desires

*** *** =org-comment-dwim=
This function seems to comment the wrong number of lines inside code blocks
Try it below, it's bound to =M-;=.
